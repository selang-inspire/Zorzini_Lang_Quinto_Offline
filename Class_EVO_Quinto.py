...
class EVO_Quinto:
    ...
    def __init__(self,log_file_name):
        ...
        self.EnergySet = ['A-drive Energy', 'B-drive Energy', 'C-drive Energy', 'C-drive rot Energy', 'GX_evo Energy', 'S-drive (grinding) Energy', 'X-drive Energy', 'Y-drive Energy'] #['A-drive Energy', 'B-drive Energy', 'C-drive Energy', 'C-drive rot Energy', 'GX_evo Energy', 'S-drive (grinding) Energy', 'S2-drive (dress) Energy', 'U-drive Energy', 'US-drive Energy', 'X-drive Energy', 'Y-drive Energy', 'Z-drive (Pallette) Energy']
